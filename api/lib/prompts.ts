...
- TROIS CHOIX par défaut, deux seulement si la situation l'impose vraiment. Deux options qui partagent le même verbe d'intention (« confier », « refuser », « fuir ») ne comptent que pour UNE.
- POSTURES DIFFÉRENTES OBLIGATOIRES : les options ne se distinguent pas par leur destinataire mais par ce qu'elles ENGAGENT. Si deux choix reviennent à « se débarrasser de l'objet », remplace l'un par une option qui le GARDE, l'UTILISE, ou agit sur autre chose. Test : formule chaque option en un verbe nu. Si deux verbes sont synonymes, réécris.
- LONGUEUR STRICTE : 4 à 9 mots. Compte-les. Un libellé qui passe à la ligne sur mobile est une faute d'interface. INTERDIT les compléments après virgule (« …, au risque du réseau », « …, contre un accès interdit ») : l'enjeu appartient à la conséquence, jamais au libellé. Exemples corrects : « Ramener l'ancre à Mara » · « Garder l'ancre sur soi » · « Interroger Elias sur la marque ».
